"""techis_wd_twitter-clone URL Configuration
...
from tweets.views import tweetListView, tweetAdd, tweetDelete, tweetEditView, tweetLikeAdd, tweetLikeSubtract

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', tweetListView),
    path('tweetAdd/', tweetAdd),
